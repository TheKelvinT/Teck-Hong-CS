...
const AboutUs = () => {
  ...
  return (
    <div className="bg-primary-100 bg-opacity-60 min-h-full grow w-full">
      ...
      <div className="flex flex-col   bg-white border border-gray-200 rounded-2xl shadow-lg md:flex-row md:max-w-xl">
        ...
        <h2 className="text-4xl uppercase my-4 text-blue-900">OUR STORY</h2>
          <h5 className="mb-4 text-md font-bold tracking-tight italic text-blue-900 opacity-80 ">Teck Hong ColdStorage story is one of healthy evolution and commitment to quality.</h5>
          <p className={paragraphStyle}>Teck Hong ColdStorage is a family-owned and operated cold storage located in Sri Aman, Sarawak, Malaysia. Since our doors first opened, we have been committed to providing our customers with a unique and personalized shopping experience.</p>
          ...
          <p className={paragraphStyle}>We are proud to serve the people of Sri Aman and the surrounding area and are committed to providing the best possible shopping experience. Thank you for choosing Teck Hong ColdStorage for your grocery needs. We look forward to serving you soon.</p>
        </div>
      </div>
