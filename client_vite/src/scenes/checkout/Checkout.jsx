  ...
  return (
    ...
    <div className="sm:w-4/5 mx-auto max-w-2xl py-8 px-4 sm:py-16 sm:px-6 lg:max-w-7xl lg:px-8  "> 
      <div className="flex flex-col-reverse md:flex-row bg-white  rounded-2xl shadow-xl  ">
         ...
         <h1 className="relative text-lg uppercase text-gray-700 ">ORDER SUMMARY<span className="my-2 block h-1 w-10 bg-teal-600 sm:w-20"></span></h1>
            <div className=" max-h-[450px] overflow-auto scrollbar-thin scrollbar-thumb-secondary-400 scrollbar-track-secondary-200 ">
